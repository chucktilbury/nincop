...
# Provide a compiler directive.
directive_definition (
    'ADD_SEARCH' '(' STRING_LITERAL ')'
)
...
operator_type (
    ...
    '_less_than_' | 'more_than_' | '_less_or_equal_' | '_more_or_equal_' |
    '_equal_' | '_not_equal_' |
...
final_clause (
    'final' '(' (type_name | 'nothing') IDENTIFIER ')' func_body
)
